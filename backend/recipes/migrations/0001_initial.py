    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', colorfield.fields.ColorField(default='#FFFFFF', help_text='Введите цвет тега в HEX', max_length=18, verbose_name='Цвет в HEX')),
                ('slug', models.CharField(help_text='Введите Slug тэга', max_length=200, verbose_name='Slug тэга')),
            ],
            options={
                'verbose_name': 'Тэг',
